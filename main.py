...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    #Upsample by 2
    input_up1 = tf.layers.conv2d_transpose(conv_1x1_7, num_classes, 4, 2, padding='same', kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
    #1x1 Convolution (4)
    ...
    #First Skip Layer
    skip_1 = tf.add(input_up1, conv_1x1_4)
    #Upsample by 2
    input_up2 = tf.layers.conv2d_transpose(skip_1, num_classes, 4, 2, padding='same', kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
    #1x1 Convolution (3)
    ...
    #Second Skip Layer
    skip_2 = tf.add(input_up2, conv_1x1_3)
    #Upsample by 8.
    input_up3 = tf.layers.conv2d_transpose(skip_2, num_classes, 16, 8, padding='same', kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
...
def optimize(nn_last_layer, correct_label, learning_rate, num_classes):
    ...
    """
    # TODO: Implement function
    #2D tensor representing pixels as rows and classes as columns
